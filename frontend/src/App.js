    ...
    <div>
      <Router>
        <Routes>
          ...
          <Route
            path="/order/inventoryRequest"
            element={<AdminInventoryRequestForm />}
          />
          <Route
            path="/productlistCustom/buyproducts"
            exact
            element={<ProductListCustom />}
          />
          <Route
            path="/productlistsuit/buyproducts"
            exact
            element={<ProductListSuit />}
          />
          <Route
            path="/productlistshirt/buyproducts"
            exact
            element={<ProductListShirt />}
          />
          <Route
            path="/productlisttrouser/buyproducts"
            exact
            element={<ProductListTrouser />}
          />
          <Route
            path="/buyproducts/accessories"
            exact
          ...
          />
          <Route
            path="/order/customsuit/:productId"
            exact
            element={<CustomSuit />}
          />
          <Route
            path="/order/customshirt/:productId"
            exact
            element={<CustomShirt />}
          />
          <Route
            path="/order/customtrouser/:productId"
            exact
          ...
          <Route path='/employee/addBonus' exact element={<AddEmployeeBonus/>}/>
