      ...
      <div style={{ maxWidth: "1170px", margin: "0 auto" }}>
        <div style={flexContainer}>
          <div style={{ display: "grid", fontSize: "15px" }}>
            ...
            >
              Specializing in Elegant Wedding Suits, Exquisite Kurthas for Sale
              & Rent, Precision Tailoring of Office Attires, Sophisticated Party
              Wears, and Premium School Uniforms. Experience the Height of Style
              and Comfort with Our Tailored Creations.
            </span>
          </div>
            ...
            >
              <li>
                <a
                  ...
                  href="https://www.facebook.com/msrtailors/"
                >
                  <FaFacebook />
                </a>
              </li>
              <li>
                <a
                  style={{ color: "black" }}
                  href="https://www.instagram.com/msr_tailors/"
                >
                  <FaInstagram />
                </a>
              </li>
