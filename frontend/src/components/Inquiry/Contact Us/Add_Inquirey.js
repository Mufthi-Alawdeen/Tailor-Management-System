...
import DetailsImage from '../Img/contact.png';
    ...
    return (
        <div>
            ...
            <div style={{ padding: 20, display: 'flex' }}>
                ...
                <div style={{ height: 'auto', width: '50%', placeContent: 'center' }}>
                    <center className={styles1.contactusText}>Contact Us</center>
                    <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                        <div className={styles1.contactusContent}>
                            <div>
                                {EmailIcon}
                            </div>
                            <div>
                    ...
                    <center style={{ justifyContent: 'center' }} className={styles1.contactusContent}>
                        <div>
                            {MapLocation}
                        </div>
                        <div>
                            No. 280A, D.S. Senanayaka Veediya, Kandy
                        </div>
                    </center>
                </div>
            </div>
            ...
            {loggedIn ? (
                ...
                <div style={{ textAlign: 'center', marginTop: '100px', fontSize: '22px', fontWeight:'650', textDecoration:'underline', marginBottom:'60px' }}>
                    <p>You Have To Login To Submit An Inquiry. Or Use Our Chat Box To Get Qucik Answers For Your Questions</p>
