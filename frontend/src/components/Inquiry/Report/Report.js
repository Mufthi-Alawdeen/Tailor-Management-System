...
import Header2 from "../Sent Inquiries and Admin Inq/Header2";
...
export default function Report() {
    ...
    const content = `
      <div style="margin: 10 auto; max-width: 800px;">
        ...
        <div style="margin-top: 40px;">
          ...
          <div style="border: 1px solid #ccc; padding: 20px; margin-bottom: 20px; margin-top: 50px; margin-left: 35px; margin-right:35px">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              <thead>
                <tr>
                  ...
                  <th style="text-align: left; padding: 8px; border-bottom: 1px solid #ccc;">Count</th>
                </tr>
              </thead>
              <tbody>
                ${types.map(type => `
          ...
          <p style="font-size:20px; margin-left: 35px;margin-right: 35px;margin-top: 100px;">According to the report, a total of ${totalInquiriesCount} inquiries were received this month. This indicates a significant level of customer engagement and highlights the importance of prompt and effective inquiry management.</p>
  ...
  return (
    <div>
      <Header2/>
      <div style={{ marginTop:'80px' ,  border: '1px solid #000000' ,marginLeft:'40px', marginRight:'40px' }} >
